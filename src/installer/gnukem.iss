...
; dj2022-11 added new fullscreen shortcut

#define MyAppName "Dave Gnukem"
#define MyAppNameFullscreen "Dave Gnukem (Fullscreen)"
...
Name: "{group}\{#MyAppNameFullscreen}"; Filename: "{app}\{#MyAppExeName}"; Parameters: "-f"
...
Filename: "{app}\{#MyAppExeName}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppNameFullscreen, '&', '&&')}}"; Flags: nowait postinstall skipifsilent unchecked; Parameters: "-f"
